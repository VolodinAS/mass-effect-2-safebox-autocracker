...
class MainLoop(QtWidgets.QMainWindow):
    def __init__(self):
        # self.ui = uic.loadUi('ME2AutoCracker.ui')
        super(MainLoop, self).__init__()
        self.ME2AutoCrackerUI = Ui_me2()
        self.ME2AutoCrackerUI.setupUi(self)
        self.init_UI()

    def init_UI(self):
        ico = QIcon(':/icons/images/icon_clear.png')
        self.setWindowIcon(ico)
        self.ME2AutoCrackerUI.checkBox.stateChanged.connect(self.state_changed)

    def state_changed(self, int):
        if self.ME2AutoCrackerUI.checkBox.isChecked():
